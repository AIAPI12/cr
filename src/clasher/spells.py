...
# Predefined spells — values in tiles (dividing by 1000 or using tile units)
# Damages at tournament standard (level 9). Radii in tiles.
ARROWS = DirectDamageSpell("Arrows", 3, radius=4.0, damage=243, crown_tower_damage_multiplier=0.30)
FIREBALL = ProjectileSpell("Fireball", 4, radius=2.5, damage=572, travel_speed=600.0/60.0, crown_tower_damage_multiplier=0.30)
ZAP = DirectDamageSpell("Zap", 2, radius=2.5, damage=159, stun_duration=0.5, crown_tower_damage_multiplier=0.30)
LIGHTNING = DirectDamageSpell("Lightning", 6, radius=2.0, damage=864, stun_duration=0.5, crown_tower_damage_multiplier=0.30)

ROCKET = ProjectileSpell("Rocket", 6, radius=2.0, damage=1400, travel_speed=350.0/60.0, crown_tower_damage_multiplier=0.30)
...
FREEZE = AreaEffectSpell("Freeze", 4, radius=3.5, damage=45, duration=5.0, freeze_effect=True)
RAGE = BuffSpell("Rage", 2, radius=5.0, damage=0, buff_duration=6.0, speed_multiplier=1.4, damage_multiplier=1.4)
MIRROR = DirectDamageSpell("Mirror", 3, radius=0.0, damage=0)
POISON = AreaEffectSpell("Poison", 4, radius=3.5, damage=228, duration=8.0, building_damage_multiplier=1.3)
GRAVEYARD = GraveyardSpell("Graveyard", 5, radius=3.5, damage=0, spawn_interval=0.5, max_skeletons=20, duration=10.0)
LOG = ProjectileSpell("Log", 2, radius=3.9, damage=288, travel_speed=1200.0/60.0, knockback_distance=1.5, hits_air=False)
TORNADO = TornadoSpell("Tornado", 3, radius=5.0, damage=0, pull_force=3.0, damage_per_second=35.0, duration=3.0)
EARTHQUAKE = DirectDamageSpell("Earthquake", 3, radius=3.5, damage=332, slow_duration=3.0, slow_multiplier=0.5, hits_air=False)
BARB_LOG = RollingProjectileSpell("BarbLog", 2, radius=0.8, damage=288, travel_speed=1200.0/60.0, knockback_distance=1.5, spawn_character="Barbarian")
HEAL = HealSpell("Heal", 3, radius=4.0, damage=0, heal_amount=400.0)
SNOWBALL = DirectDamageSpell("Snowball", 2, radius=2.5, damage=0, slow_duration=2.5, slow_multiplier=0.65, crown_tower_damage_multiplier=0.30, knockback_distance=1.0)
ROYAL_DELIVERY = RoyalDeliverySpell("RoyalDelivery", 3, radius=3.0, damage=171)
GLOBAL_CLONE = DirectDamageSpell("GlobalClone", 3, radius=0.0, damage=0)
GOBLIN_PARTY_ROCKET = ProjectileSpell("GoblinPartyRocket", 4, radius=2.5, damage=0, travel_speed=1000.0/60.0)
WARM_SPELL = DirectDamageSpell("WarmSpell", 0, radius=0.0, damage=0)
GLOBAL_LIGHTNING = DirectDamageSpell("GlobalLightning", 6, radius=3.0, damage=1440)
DARK_MAGIC = DirectDamageSpell("DarkMagic", 4, radius=3.0, damage=0)
GOBLIN_CURSE = DirectDamageSpell("GoblinCurse", 3, radius=3.0, damage=0)
MERGE_MAIDEN = DirectDamageSpell("MergeMaiden", 4, radius=0.0, damage=0)
